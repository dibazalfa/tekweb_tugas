 ...
 <p> 1. START 2. UPLOAD SUBMISSION <b> 3. ENTER METADATA </b> 4. UPLOAD SUPPLEMENTARY FILES 5. CONFIRMATION </p>
 <h2> Authors </h2>
 ...
 <input type="text" class="form-control" id="nama_tengah" name="nama_tengah"> <br>
 <label for="nama_akhir">Last Name *</label>
 <input type="text" class="form-control" id="nama_akhir" name="nama_akhir"> <br>
 <label for="email">Email *</label>
 <input type="text" class="form-control" id="email" name="email"> <br>
 <label for="url">URL</label>
 <input type="text" class="form-control" id="url" name="url"> <br>
 <label for="bidang">Affiliation</label>
 <textarea id="bidang" name="bidang" class="form-control" rows="5" cols="50">
 ...
 <textarea class="form-control" id="bio" name="bio" rows="5" cols="50">
 ...
 <input type="submit" value="Add Author">
  ...
  <label for=" ">Title *</label> 
   <input type="username" class="form-control" id="judul" name="judul"> <br> 
   <label for=" ">Abstract</label> 
    <textarea class="form-control" id="abstrak" name="abstrak" rows="5" cols="50"> 
   </textarea> <br> 
   <h2> Indexing </h2> 
   <p> Provide terms for indexing the submission; separate terms with a semi-colon (term1; term2; term3). </p> 
   <label for=" ">Keywords</label> 
    <input type="username" class="form-control" id="katakunci" name="katakunci" value="Photosynthesis; Black Holes; Four-Color Map Problem; Bayesian Theory"> <br> 
    <label for=" ">Language</label> 
    <input type="username" value="en" class="form-control" id="bahasa" name="bahasa"> <br> 
    ...
    <input type="username" class="form-control" id="kontributor" name="kontributor"> <br> 
    <h2> References </h2> 
    ...
    <textarea class="form-control" id="referensi" name="referensi" rows="5" cols="50"> 
   </textarea> <br> 
   <input type="submit" value="Save and Continue"> <input type="submit" value="Cancel"> 
